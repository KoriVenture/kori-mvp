...
- The active reference tree includes no private signing key. Any historically
  exposed Testnet fixture is permanently compromised. Operators must use secure
  local identities and never reuse them for Mainnet.
