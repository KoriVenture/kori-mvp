...
| Milestone approval and release         | `submit_evidence`, `approve_evidence`, and `release` in [`lib.rs`](./contracts/kori-deal-escrow/src/lib.rs)                                          |
...
## Alignment verified on 2026-08-25
