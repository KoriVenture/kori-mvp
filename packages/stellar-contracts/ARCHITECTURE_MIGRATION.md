...
Stellar-native authorization and asset movement. It is deliberately isolated
from the root Next.js application; historical EVM code is comparison material,
not an active implementation dependency.
...
The public V1 Testnet deployment is configured and verified with Lead weight `1`,
